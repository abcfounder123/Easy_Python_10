...
b1 = Button(x, command=f1, width=8, height=4, text="", font=('Arial', 30, 'bold'))
...
b4 = Button(x, command=f4, width=8, height=4, text="", font=('Arial', 30, 'bold'))
b5 = Button(x, command=f5, width=8, height=4, text="", font=('Arial', 30, 'bold'))
b6 = Button(x, command=f6, width=8, height=4, text="", font=('Arial', 30, 'bold'))

b7 = Button(x, command=f7, width=8, height=4, text="", font=('Arial', 30, 'bold'))
b8 = Button(x, command=f8, width=8, height=4, text="", font=('Arial', 30, 'bold'))
b9 = Button(x, command=f9, width=8, height=4, text="", font=('Arial', 30, 'bold'))
