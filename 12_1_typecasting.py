...
11. Explicit type casting (str to program value)
...
12. Explicit type casting (str to program value) (Dynamic formla)
...
- Implicit type casting (indirect) (2)(float, bool)
